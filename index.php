...
<html lang="en">
  ...
  <body id="0">
    ...
    <div class="container-header" id="header-LP">
      ...
      <div class="continuar">
        <a href="#main__text" class="flecha-continuar"
          ><img src="./media/img/continuar.png"
        /></a>
      </div>
    </div>
    ...
    <div class="container-navbar">
      <div class="logo-navbar">
        <a href="#"
          ><img src="./media/img/marca-agua-negro.png" alt=""
        /></a>
      </div>
    ...
    <div class="container-footer">
      <footer class="footer">
        <div class="caja-iconos">
          <a draggable="false" class="icon" href="#"
            ><img draggable="false" src="./media/img/yt.png"
          /></a>
        </div>
        <div class="caja-iconos">
          <a
            draggable="false"
            class="icon"
            href="https://www.instagram.com/gadigamescep/"
            ><img draggable="false" src="./media/img/insta.png"
          /></a>
        </div>
        <div class="caja-iconos">
          <a draggable="false" class="icon-2" href="#0"
            ><img draggable="false" src="./media/img/gadi.png"
          /></a>
        </div>
        <div class="caja-iconos">
          <a
            draggable="false"
            class="icon"
            href="https://github.com/doniagoo/proyectoGadi"
            ><img draggable="false" src="./media/img/git.png"
          /></a>
        </div>
        <div class="caja-iconos">
          <a draggable="false" class="icon" href="https://twitter.com/gadigames"
            ><img draggable="false" src="./media/img/twitter.png"
          /></a>
        </div>
      </footer>
    </div>
