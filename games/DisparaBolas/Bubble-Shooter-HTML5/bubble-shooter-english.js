...
/*------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
    ...
    function render() {
        ...
        if (gamestate == gamestates.gameover) {
            ...
            if (score > 11000){
                drawCenterText("You have done lot of points! Good!", nivel.x, nivel.y + nivel.height / 2 + 70, nivel.width);
                drawCenterText("Persistence and striving make us better", nivel.x, nivel.y + nivel.height / 2 + 100, nivel.width);
            } else{
                drawCenterText("You need to practice something else, don't give up!", nivel.x, nivel.y + nivel.height / 2 + 70, nivel.width);
            }
            drawCenterText("Click to restart",  nivel.x, nivel.y + nivel.height / 2 + 130, nivel.width);
            //canvas acabado
