...
<body>
  ...
  <div class="container">
    ...
    if ($userActivo['es_admin'] == '1') { ?>
      ...
      <?php } else {
      $ShooterUnlocked = getScoreGame($userActivo['id'], 3);
      $ShooterUnlocked = intval($ShooterUnlocked['score']);
      if ($ShooterUnlocked == 0) { ?>
        <div class="juego">
          <div class="imagen__juego">
    ...
    if ($userActivo['es_admin'] == '1') { ?>
      ...
      <?php } else {
      $PacmanUnlocked = getScoreGame($userActivo['id'], 5);
      $PacmanUnlocked = intval($PacmanUnlocked['score']);
      if ($PacmanUnlocked == 0) { ?>
        <div class="juego">
          <div class="imagen__juego">
